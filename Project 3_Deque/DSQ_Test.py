...
class DSQTester(unittest.TestCase):
    ...
    def test_peek_front_value_of_three_element(self):
        self.__deque.push_front(1)
        self.__stack.push(2)
        self.__queue.enqueue(None)
        self.__deque.push_back(2)
    ...
    def test_peek_back_value_of_three_element(self):
        self.__deque.push_front(1)
        self.__deque.push_back(2)
        self.__deque.push_back(None)
        returned1=self.__deque.peek_back()
    ...
    def test_pop_front_back_when_empty(self):
        a = self.__deque.pop_front()
        b = self.__deque.pop_back()
        c = self.__stack.pop()
        d = self.__queue.dequeue()
